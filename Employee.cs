...
namespace Shop_Management__System
{
    public partial class Employee : Form
    {
        ...
        public void setEmpId()
        {
            ...
            object result = cmd.ExecuteScalar();  // Handle DBNull
            con.Close();
            ...
            i++;  // Increment the ID
            string oId = "E" + i.ToString("D3");  // Format to 3 digits
            txtEm_Id.Text = oId;
        }
        ...
        private void btnAdd_em_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (count == 0)
                {
                    string q = "INSERT INTO EMPLOYEE(EMP_ID,EMP_Name,EMP_BirthDay,EMP_Cit,EMP_Login,EMP_Password,EMP_Salary) VALUES('" + txtEm_Id.Text.ToString() + "','" + txtEm_Name.Text.ToString() + "','" + Em_birth.Text.ToString() + "','" + txtEm_Add.Text.ToString() + "','" + em_login.Text.ToString() + "','" + em_Pw.Text.ToString() + "','" + txtSalary.Text.ToString() + "')";
        ...
        private void btnUpdate_em_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (count == 1)
                {
                    string q = "UPDATE EMPLOYEE SET EMP_Name='" + txtEm_Name.Text.ToString() + "',EMP_Birthday='" + Em_birth.Text.ToString() + "',EMP_Cit='" + txtEm_Add.Text.ToString() + "',EMP_Login='" + em_login.Text.ToString() + "',EMP_Password='" + em_Pw.Text.ToString() + "',EMP_Salary ='" + txtSalary.Text.ToString() + "' where EMP_ID ='" + txtEm_Id.Text.ToString() + "'";
                    SqlCommand cmd = new SqlCommand(q, con);
                    cmd.ExecuteNonQuery();
                    disp_data();
